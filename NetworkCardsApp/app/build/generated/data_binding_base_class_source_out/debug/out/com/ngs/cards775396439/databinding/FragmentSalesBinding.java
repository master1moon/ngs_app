...
public final class FragmentSalesBinding implements ViewBinding {
  ...
  private FragmentSalesBinding(@NonNull CoordinatorLayout rootView,
      ...
      @NonNull FloatingActionButton fabAddSale, @NonNull LinearLayout loadingState,
      @NonNull RecyclerView recyclerViewSales) {
  ...
  public static FragmentSalesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentSalesBinding((CoordinatorLayout) rootView, btnExportExcel, btnExportJson,
          btnExportPdf, emptyState, fabAddSale, loadingState, recyclerViewSales);
    }
