...
public final class DialogInventoryBinding implements ViewBinding {
  ...
  @NonNull
  public final TextInputEditText etInventoryQuantity;
  ...
  private DialogInventoryBinding(@NonNull LinearLayout rootView, @NonNull MaterialButton btnCancel,
      ...
      @NonNull TextInputEditText etInventoryQuantity, @NonNull AutoCompleteTextView spinnerPackage,
      @NonNull TextView tvDialogTitle) {
    this.rootView = rootView;
    this.btnCancel = btnCancel;
    this.btnSave = btnSave;
    this.etInventoryDate = etInventoryDate;
    this.etInventoryQuantity = etInventoryQuantity;
  ...
  public static DialogInventoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.etInventoryQuantity;
      TextInputEditText etInventoryQuantity = ViewBindings.findChildViewById(rootView, id);
      if (etInventoryQuantity == null) {
        break missingId;
      }
      ...
      return new DialogInventoryBinding((LinearLayout) rootView, btnCancel, btnSave,
          etInventoryDate, etInventoryQuantity, spinnerPackage, tvDialogTitle);
    }
