...
public final class FragmentStoresBinding implements ViewBinding {
  ...
  private FragmentStoresBinding(@NonNull CoordinatorLayout rootView,
      ...
      @NonNull FloatingActionButton fabAddStore, @NonNull LinearLayout loadingState,
      @NonNull RecyclerView recyclerViewStores) {
  ...
  public static FragmentStoresBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentStoresBinding((CoordinatorLayout) rootView, btnExportExcel, btnExportJson,
          btnExportPdf, emptyState, fabAddStore, loadingState, recyclerViewStores);
    }
