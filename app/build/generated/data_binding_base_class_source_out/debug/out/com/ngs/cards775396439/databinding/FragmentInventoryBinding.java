...
public final class FragmentInventoryBinding implements ViewBinding {
  ...
  private FragmentInventoryBinding(@NonNull CoordinatorLayout rootView,
      ...
      @NonNull FloatingActionButton fabAddInventory, @NonNull LinearLayout loadingState,
      @NonNull RecyclerView recyclerViewInventory) {
  ...
  public static FragmentInventoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentInventoryBinding((CoordinatorLayout) rootView, btnExportExcel,
          btnExportJson, btnExportPdf, emptyState, fabAddInventory, loadingState,
          recyclerViewInventory);
    }
