...
public final class FragmentAboutBinding implements ViewBinding {
  ...
  private FragmentAboutBinding(@NonNull ScrollView rootView, @NonNull MaterialButton btnCall,
      @NonNull MaterialButton btnEmail, @NonNull MaterialButton btnWebsite,
      @NonNull MaterialButton btnWhatsapp, @NonNull TextView tvEmail, @NonNull TextView tvPhone,
  ...
  public static FragmentAboutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.btn_website;
      MaterialButton btnWebsite = ViewBindings.findChildViewById(rootView, id);
      if (btnWebsite == null) {
        break missingId;
      }
      ...
      return new FragmentAboutBinding((ScrollView) rootView, btnCall, btnEmail, btnWebsite,
          btnWhatsapp, tvEmail, tvPhone, tvWebsite);
    }
